...
public class ProjectTP {
    ...
    static String[] Rute = {"Malang-Surabaya", "Malang-Jakarta", "Malang-Palembang"};
    static String[] Rute1 = {"Surabaya-Jakarta", "Jakarta-Kuala lumpur", "Malang-Irian jaya"};
    static String[] Rute2 = {"Malang-Maluku", "Jakarta-Banjarmasin", "Malang-Bandung"};
